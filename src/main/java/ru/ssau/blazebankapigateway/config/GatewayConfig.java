...
import ru.ssau.blazebankapigateway.filter.AuthFilter;
import ru.ssau.blazebankapigateway.filter.PostGlobalFilter;

// TODO: Сменить логику на ту, что используется в приложении
@Configuration
